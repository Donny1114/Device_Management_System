...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Dionn\Documents\Programming\Python\pythonProject'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Dionn\Documents\Programming\Python\pythonProject\Scripts\deactivate.nu'
